...
public class AclClass extends TableImpl<AclClassRecord> {
    ...
    private static final long serialVersionUID = -856056860;
    ...
    private AclClass(String alias, Table<AclClassRecord> aliased) {
        this(alias, aliased, null);
    }

    private AclClass(String alias, Table<AclClassRecord> aliased, Field<?>[] parameters) {
