...
public class AclEntry extends TableImpl<AclEntryRecord> {
    ...
    private static final long serialVersionUID = 1125939052;
    ...
    private AclEntry(String alias, Table<AclEntryRecord> aliased) {
        this(alias, aliased, null);
    }

    private AclEntry(String alias, Table<AclEntryRecord> aliased, Field<?>[] parameters) {
